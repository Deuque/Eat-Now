...
//                                appstate.addToDelivery(ditem);
                                pr.show();
                                ApiResponse response = await CrudOperations.uploadDelivery(ditem);
                                pr.hide();
                                if(response.error){
                                  Fluttertoast.showToast(msg: response.errorMessage, toastLength: Toast.LENGTH_LONG);
                                }
//                                appstate.deleteAllCartItems();
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (_) => OrderSuccess())).then((value){
