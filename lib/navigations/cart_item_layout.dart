          ...
          padding: EdgeInsets.only(left:7.0,right: 7.0),
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Divider(height: 1,color: appstate.aux8,),
                      Row(
                        ...
                        children: <Widget>[
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  IconButton(
                                    ...
                                    icon: Icon(Icons.remove_circle,color: appstate.aux3,),
                                  ),
                                  Text(
                                  ...
                                  IconButton(
                                    ...
                                    icon: Icon(Icons.add_circle,color: appstate.aux3,),
                                  ),
                                ],
                              )
                          ),
                          IconButton(
                            iconSize: 20,
                            icon: Image.asset('assets/delete.png',color: appstate.aux2,height: 16,width: 16,),
