...
var sampleCaroussels = [
  ...
  Caroussel(
    ...
    body: 'We require no interest rate from our credit facilities, as long as payment is made right on time',
  ),
  Caroussel(
    path: 'assets/ob3.jpeg',
    title: 'Delivery in 30mins',
    body: 'Our delivery time is 30mins, you could literally countdown till your order gets to you',
  ),
  Caroussel(
    path: 'assets/ob4.jpeg',
    title: 'Instant Credit',
    body: 'Once you login you will receive instant credit to purchase food immediately',
  ),
];