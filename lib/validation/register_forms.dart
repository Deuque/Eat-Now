...
class RegForms extends StatelessWidget {
  final label;
  final resolvetext;
  bool isPassword,isNum;

  RegForms({this.label, this.resolvetext, this.isPassword=false, this.isNum=false});
...
class RegImage extends StatelessWidget {
  ...
  RegImage({this.label, this.text, this.resolveFile});
            ...
            SizedBox(
              ...
              child: FlatButton(
                ...
                child: Text(
                  label,
                  style: GoogleFonts.sourceSansPro(
                      color: aux1, fontWeight: FontWeight.w400, fontSize: 14),
                ),
              ),
            )
          ],
